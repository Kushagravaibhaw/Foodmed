...
public class PassangerSummery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_passanger_summery);
        ...
        confirmo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(c.getCount()>0)
                    Toast.makeText(PassangerSummery.this, "This OrderID Already Exists", Toast.LENGTH_SHORT).show();
                else {
                    db.execSQL("insert into Bill values('" +nme+ "'," + hotid + ",'" + ordi + "','" + pnum + "','" + tnum + "','" + cnm + "','" + snm + "','" +biln + "' )");
                    Toast.makeText(PassangerSummery.this, "Congratulations Your Order Is Place Successful", Toast.LENGTH_SHORT).show();
                }
            }
        });
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PassangerSummery.this,MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK));
            }
        });
        otherorder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PassangerSummery.this,Passanger.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK));
            }
        });
