    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hotelrestpassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Cursor c=db.rawQuery("select * from HotelReg where username=?",new String[]{hnewusername+""});
                if(c.getCount()==0)
                    ...
                    db.execSQL("Update HotelReg set password='"+hnewpassword+"' where username= "+hnewusername);
                    String hnewconfirmpassword=hotelnewconfirmpassword.getText().toString();
                    db.execSQL("Update HotelReg set confirmpassword='"+hnewconfirmpassword+"' where username= "+hnewusername);
        ...
        hotellogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(HotelForgotPassword.this,HotelLogin.class));
            }
        });
    }
}